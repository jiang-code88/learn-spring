...
import com.learn._04_advanced._09_advance_componentScan.basePackageClassesComponentScan.componentBean.DemoComponent;
 ...
 *  1 指定 DemoService.class 将只扫描导入 DemoService 和 DemoDao 的 bean
 *  2 指定 DemoComponent.class 将只扫描导入 DemoComponent 和该类所在包及其子包中 InnerComponent 的 bean
 */
@Configuration
