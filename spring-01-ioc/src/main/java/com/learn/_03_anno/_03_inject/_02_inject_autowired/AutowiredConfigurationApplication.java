...
import com.learn._03_anno._03_inject._02_inject_autowired.conf.AutowiredBeanConfiguration;
 ...
 */
public class AutowiredConfigurationApplication {
    public static void main(String[] args) {
        ...
        ZooBean zooBean = context.getBean("zooBean", ZooBean.class);
        System.out.println(zooBean);
    }
}
