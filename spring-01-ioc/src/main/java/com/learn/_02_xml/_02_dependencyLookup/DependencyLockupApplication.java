...
public class DependencyLockupApplication {
    public static void main(String[] args) {
        ...
        ObjectProvider<Cat> beanProvider = context.getBeanProvider(Cat.class);
        ...
        Cat catSupplier = beanProvider.getIfAvailable(() -> {
            return new Cat();
        });
        ...
        // 如果找到 bean 马上执行方法调用
        context.getBeanProvider(Dog.class).ifAvailable((o)->{
